  ...
  function initScrollMagic() {
    ...
    $navItem.each(function () {
      var slideHREF = $(this).find('a').attr('href'),
        ...
        moveNav = TweenMax.to($('.nav-active'), 1, {
          x: '+=26',
    ...
    function crossFade($slideOut, $slideIn, direction, slideIndex) {
      ...
      crossFadeTl
        ...
        .to([$slideOutTitle, $slideOutNumber, $layers], 0.3, {
          autoAlpha: 0,
          ease: Linear.easeNone,
        })
      ...
      if (slideInID == 09) {
        ...
        scrambleTextTl.to($slideInNumber, 1.4, {
          scrambleText: 'Share',
          autoAlpha: 1,
          ease: Power1.easeOut,
        });
        ...
        // fade number in
        countUpText.to($slideInNumber, 1.2, {
          autoAlpha: 1,
          ease: Linear.easeNone,
      ...
      if (direction == 'FORWARD') {
        ...
        var tweenBcg = TweenMax.to($slideOutBcg, 0.7, {
          autoAlpha: 0,
          ease: Linear.easeNone,
          onComplete: hideOldSlide,
          onCompleteParams: [$slideOut],
      ...
      if (slideInID == 01) {
        var fadeInSVG = TweenMax.to($layers, 0.3, {
          autoAlpha: 1,
          ease: Linear.easeNone,
        });
    ...
    function updateNav(slideOutID, slideInID) {
      ...
      TweenMax.set($('.nav-items li.nav-item' + slideInID), {
        className: '+=active',
      });
    }
    ...
    function animationIn($slideIn) {
      ...
      transitionInTl
        .set([$slide, $slideInNumber, $nav], { autoAlpha: 0 })
        .set($slideIn, { autoAlpha: 1 })
        ...
        .staggerFrom(
          $slideInTitle,
          0.3,
          { autoAlpha: 0, x: '-=60', ease: Power1.easeOut },
          0.1,
          'fadeInLogo+=0.9'
        )
